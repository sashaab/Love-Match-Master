...
export const celebritiesData = [
  { id: '1', type: 'celebrity', name: { en: 'Taylor Swift', ru: 'Тейлор Свифт' }, imageUrl: '/images/celebrities/Taylor Swift.png', partner: { en: 'Travis Kelce', ru: 'Трэвис Келси' }, exes: [{ en: 'Tom Hiddleston', ru: 'Tom Hiddleston' }, { en: 'Jake Gyllenhaal', ru: 'Jake Gyllenhaal' }] },
  ...
  { id: '35', type: 'celebrity', name: { en: 'Harry Styles', ru: 'Гарри Стайлс' }, imageUrl: '/images/celebrities/Harry Styles.png', partner: undefined, exes: [{ en: 'Taylor Swift', ru: 'Тейлор Свифт' }, { en: 'Camille Rowe', ru: 'Camille Rowe' }, { en: 'Olivia Wilde', ru: 'Olivia Wilde' }] },
  ...
  { id: '39', type: 'celebrity', name: { en: 'Pete Davidson', ru: 'Пит Дэвидсон' }, imageUrl: '/images/celebrities/Pete Davidson.png', partner: { en: 'Ariana Grande', ru: 'Ариана Гранде' }, exes: [{ en: 'Kim Kardashian', ru: 'Ким Кардашьян' }] },
  ...
  { id: '42', type: 'celebrity', name: { en: 'Robert Pattinson', ru: 'Роберт Паттинсон' }, imageUrl: '/images/celebrities/Robert Pattinson.png', partner: { en: 'Suki Waterhouse', ru: 'Суки Уотерхаус' }, exes: [{ en: 'Kristen Stewart', ru: 'Кристен Стюарт' }] },
  { id: '43', type: 'celebrity', name: { en: 'Suki Waterhouse', ru: 'Суки Уотерхаус' }, imageUrl: '/images/celebrities/Suki Waterhouse.png', partner: { en: 'Robert Pattinson', ru: 'Роберт Паттинсон' }, exes: [] },
  ...
  { id: '58', type: 'celebrity', name: { en: 'Tom Hiddleston', ru: 'Tom Hiddleston' }, imageUrl: '/images/celebrities/Tom Hiddleston.png', partner: undefined, exes: [] },
  { id: '59', type: 'celebrity', name: { en: 'Jake Gyllenhaal', ru: 'Jake Gyllenhaal' }, imageUrl: '/images/celebrities/Jake Gyllenhaal.png', partner: undefined, exes: [] },
  ...
  { id: '62', type: 'celebrity', name: { en: 'Macaulay Culkin', ru: 'Макаulay Калкин' }, imageUrl: '/images/celebrities/Macaulay Culkin.png', partner: undefined, exes: [] },
  ...
  { id: '65', type: 'celebrity', name: { en: 'Amber Rose', ru: 'Амбер Роуз' }, imageUrl: '/images/celebrities/Amber Rose.png', partner: undefined, exes: [] },
  ...
  { id: '77', type: 'celebrity', name: { en: 'Maksim Vitorgan', ru: 'Максим Виторган' }, imageUrl: '/images/celebrities/Максим Виторган.png', partner: undefined, exes: [] },
  { id: '78', type: 'celebrity', name: { en: 'Darya Moroz', ru: 'Дарья Мороз' }, imageUrl: '/images/celebrities/Дарья Мороз.png', partner: undefined, exes: [] },
  { id: '79', type: 'celebrity', name: { en: 'Agata Muceniece', ru: 'Агата Муцениеце' }, imageUrl: '/images/celebrities/Агата Муцениеце.png', partner: undefined, exes: [] },
  { id: '80', type: 'celebrity', name: { en: 'Irina Starshenbaum', ru: 'Ирина Старшенбаум' }, imageUrl: '/images/celebrities/Ирина Старшенбаум.png', partner: undefined, exes: [] },
  { id: '81', type: 'celebrity', name: { en: 'Camille Rowe', ru: 'Camille Rowe' }, imageUrl: '/images/celebrities/Camille Rowe.png', partner: undefined, exes: [] },
  { id: '82', type: 'celebrity', name: { en: 'Olivia Wilde', ru: 'Olivia Wilde' }, imageUrl: '/images/celebrities/Olivia Wilde.png', partner: undefined, exes: [] },
