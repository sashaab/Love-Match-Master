...
export const i18n = {
  en: {
    ...
    levelEasy: "Easy: All hints are unlocked from the start.",
    levelMedium: "Medium: Standard mode. Unlock hints with points.",
    levelHard: "Hard: A real challenge! Celebrity names are hidden until you make a match.",
  },
  ru: {
    score: 'Счет',
    moves: 'Ходы',
    ...
    levelEasy: "Легкий: Все подсказки открыты с самого начала.",
    levelMedium: "Средний: Стандартный режим. Открывай подсказки за очки.",
    levelHard: "Сложный: Настоящий вызов! Имена знаменитостей скрыты, пока ты не соберешь пару.",
  },
};
