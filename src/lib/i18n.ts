...
export const i18n = {
  en: {
    ...
    rule4: "↔️ Movement: You can only move celebrities to an adjacent empty cell. You can either drag them or click on two adjacent cards to swap them.",
  ...
  ru: {
    ...
    rule4: "↔️ Перемещение: Ты можешь перемещать знаменитостей только на соседнюю пустую клетку. Ты можешь перетаскивать их или нажимать на две соседние карточки, чтобы поменять их местами.",
