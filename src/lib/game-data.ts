...
export const celebritiesData = [
  ...
  { id: '9', type: 'celebrity', name: { en: 'Bianca Censori', ru: 'Бьянка Цензори' }, imageUrl: '/images/celebrities/Bianca Censori.png', partner: { en: 'Kanye West', ru: 'Канье Уэст' }, exes: [] },
  { id: '10', type: 'celebrity', name: { en: 'Kanye West', ru: 'Канье Уэст' }, imageUrl: '/images/celebrities/Kanye West.png', partner: { en: 'Bianca Censori', ru: 'Бьянка Цензори' }, exes: [{ en: 'Amber Rose', ru: 'Эмбер Роуз' }, { en: 'Kim Kardashian', ru: 'Ким Кардашьян' }] },
  { id: '11', type: 'celebrity', name: { en: 'Joe Jonas', ru: 'Джо Джонас' }, imageUrl: '/images/celebrities/Joe Jonas.png', partner: [], exes: [{ en: 'Sophie Turner', ru: 'Софи Тёрнер' }, { en: 'Taylor Swift', ru: 'Тейлор Свифт' }, { en: 'Gigi Hadid', ru: 'Джиджи Хадид' }] },
  { id: '12', type: 'celebrity', name: { en: 'Sophie Turner', ru: 'Софи Тёрнер' }, imageUrl: '/images/celebrities/Sophie Turner.png', partner: [], exes: [{ en: 'Joe Jonas', ru: 'Джо Джонас' }] },
  ...
  { id: '47', type: 'celebrity', name: { en: 'Katie Holmes', ru: 'Кэти Холмс' }, imageUrl: '/images/celebrities/Katie Holmes.png', partner: [], exes: [{ en: 'Tom Cruise', ru: 'Том Круз' }] },
  ...
  { id: '52', type: 'celebrity', name: { en: 'Ben Affleck', ru: 'Бен Аффлек' }, imageUrl: '/images/celebrities/Ben Affleck.png', partner: [], exes: [{ en: 'Jennifer Lopez', ru: 'Дженнифер Лопес' },{ en: 'Jennifer Garner', ru: 'Дженнифер Гарнер' }, { en: 'Ana de Armas', ru: 'Ана де Армас' }] },
  { id: '53', type: 'celebrity', name: { en: 'Jennifer Lopez', ru: 'Дженнифер Лопес' }, imageUrl: '/images/celebrities/Jennifer Lopez.png', partner: [], exes: [{ en: 'Ben Affleck', ru: 'Бен Аффлек' }] },
  ...
  { id: '103', type: 'celebrity', name: { en: 'Petr Dranga', ru: 'Петр Дранга' }, imageUrl: '/images/celebrities/Petr Dranga.png', partner: { en: 'Agata Muceniece', ru: 'Агата Муцениеце' }, exes: [] },
  { id: '104', type: 'celebrity', name: { en: 'Julia Vlasova', ru: 'Юлия Власова' }, imageUrl: '/images/celebrities/Johnny Depp.png', partner: { en: 'Johnny Depp', ru: 'Джонни Депп' }, exes: [] }
];